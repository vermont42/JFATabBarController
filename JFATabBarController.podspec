Pod::Spec.new do |s|
  ...
  s.version          = "1.0.0"
  s.summary          = "JFATabBarController is a replacement for UITabBarController that allows the user to scroll to an arbitrary number of tab-bar items. Transitions can optionally be animated."
